...
fun rememberZoomableState(
    ...
    doubleTapOutScale: Float = ZoomableDefaults.DoubleTapOutScale,
...
class ZoomableState(
    ...
    /**
     * The [scale] value to animate to when a double tap happens while zoomed.
     */
    var doubleTapOutScale: Float = ZoomableDefaults.DoubleTapOutScale
...
object ZoomableDefaults {
    ...
    /**
     * The default value for [ZoomableState.doubleTapOutScale].
     */
    const val DoubleTapOutScale = 2f
